...
/****************************以下内容为流程控制变量****************************/
//可发起角色列表
var canLaunch = ["发起人(联席办)"];
/*
 发起流程 -->联席办负责人审批 -->计划科审批 -->分管领导审批 -->主要领导审批 -->流程结束
 */
/****************************以下内容为流程内容变量****************************/
//日期
var date;
...
function setControlData() {
    ...
    // isAbleSelectBranch = instance.nextStep == "联席办负责人审批" || instance.nextStep == "计划科审批";
...
function initContentInterface() {
    ...
    if(instance.launcherSection != "领导"){
        ...
        initSectionApproveControl(instance.currentStep == "联席办负责人审批",undefined);//科长审批信息显示控制
...
$(document).ready(
    function init() {
        initCommon("paymentApproveJoinUnion");
