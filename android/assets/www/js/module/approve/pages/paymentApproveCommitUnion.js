...
function initContentInterface() {
    ...
    if(instance.launcherSection != "领导"){
        ...
        initManagerApproveControl(instance.currentStep == "委工会负责人审批",undefined);//科长审批信息显示控制
...
$(document).ready(
    function init() {
        initCommon("paymentApproveCommitUnion");
