...
function initContentInterface() {
    ...
    if(instance.launcherSection != "领导"){
        ...
        initSectionApproveControl(instance.currentStep == "组织/老干部负责人审批",undefined);//科长审批信息显示控制
        var a = instance.currentStep == "组织/老干部负责人审批";
...
$(document).ready(
    function init() {
        initCommon("paymentApproveOrganization");
