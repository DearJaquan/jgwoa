        ...
        switch (instance.currentStep){
            case "发起流程":
                if(user.launchRole.name.indexOf("领导") > -1){
                    if(user.launchRole.name == "分管领导"){
                        instance.nextStep = "计划科审批";
                    }else if(user.launchRole.name == "行政主要领导"){
                        instance.nextStep = "行政办确认";
                    }else if(user.launchRole.name == "党委主要领导"){
                        instance.nextStep = "党委办确认";
                    }
                }else{
                    if(user.launchRole.name == "计划科科员"){
                        instance.nextStep = "计划科审批";
                    }else{
            ...
            case "行政办确认":
                ...
                break;
            case "计划科审批":
                if(instance.launcherSection == instance.launcherName){
...
function setControlData() {
    ...
    isAbleSelectMain = instance.nextStep == "分管领导审批";
    isShowMainSelect = isAbleSelectMain;
...
function getContent() {
    ...
    switch (instance.currentStep) {
        ...
        case "行政办确认":
            ...
            content.timeConfirm = new Date().Format();
            break;
    }
...
function initContentInterface() {
    ...
    if(instance.launcherSection != "领导"){
        ...
        initSectionApproveControl(instance.currentStep == "科室审批",undefined);//科长审批信息显示控制
