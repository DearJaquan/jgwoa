...
function initContentInterface(){
    ...
    if(instance.isOperator && (instance.currentStep == "发起流程" || instance.currentStep == "科室审批" ||instance.currentStep == "行政办确认" || (instance.currentStep == "传阅人审批"&&(firstAssigneeList.indexOf(user.id) >-1 ||canTransfer())))){
...
function canTransfer() {
    ...
    user.roleList.forEach(function (value) {
        if(value.name.indexOf("科长")>-1 && value.name.indexOf("财务科科长") == -1){
            canTransfer = true;
        }
    });
    return canTransfer;
